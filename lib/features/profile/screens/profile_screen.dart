              ...
              GlassCard(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 20),
                    _buildInfoItem('User ID', _currentUser?.uid ?? 'N/A'),
                    _buildInfoItem('Email Verified',
                        _currentUser?.emailVerified.toString() ?? 'false'),
                    _buildInfoItem(
                        'Account Created',
                    ...
                    _buildInfoItem(
                        'Last Sign In',
                        _currentUser?.metadata.lastSignInTime?.toString() ??
                            'N/A'),
